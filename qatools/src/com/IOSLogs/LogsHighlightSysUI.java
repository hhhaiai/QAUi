...
public class LogsHighlightSysUI extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3424438367661406447L;
	Logger logger = LoggerFactory.getLogger(LogsHighlightSysUI.class);
	 ...
	 * Create the frame.
	 */
	public LogsHighlightSysUI(final LogsCheckSysLogs logsCheckLogs) {
		...
		//本文栏
		textArea_hightlight = new JTextArea(com.Viewer.MainRun.paramsBean.getIOS_Logs_highlight().replaceAll(";", ";\n"));
		...
		btnOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//存储
				com.Viewer.MainRun.paramsBean.setIOS_Logs_highlight( textArea_hightlight.getText().replaceAll("\n", ""));
				com.Viewer.MainRun.xmlOperationUtil.XMLChanger("IOS_Logs_highlight", textArea_hightlight.getText().replaceAll("\n", ""));
				//更新
				logsCheckLogs.setMap_highlight(MainRun.paramsBean.getIOS_Logs_highlight());
				dispose();
