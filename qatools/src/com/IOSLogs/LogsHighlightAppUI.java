...
public class LogsHighlightAppUI extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3424438367661406447L;
	Logger logger = LoggerFactory.getLogger(LogsHighlightAppUI.class);
	 ...
	 * Create the frame.
	 */
	public LogsHighlightAppUI(final LogsCheckAppLogs logsCheckLogs) {
		...
		// 本文栏
		textArea_hightlight = new JTextArea(
				com.Viewer.MainRun.paramsBean.getIOS_Logs_App_highlight().replaceAll(";", ";\n"));
		...
		btnOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				com.Viewer.MainRun.paramsBean
						.setIOS_Logs_App_highlight(textArea_hightlight.getText().replaceAll("\n", ""));
				com.Viewer.MainRun.xmlOperationUtil.XMLChanger("IOS_Logs_App_highlight",
						textArea_hightlight.getText().replaceAll("\n", ""));
				// 更新
				logsCheckLogs.setMap_highlight(MainRun.paramsBean.getIOS_Logs_App_highlight());
				dispose();
