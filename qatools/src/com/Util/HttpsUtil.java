...
public class HttpsUtil {
     ...
     * @return
     */
	public static Map<String, Object> sendPostData(String server,String api,Object params,Map<String, String> headers) {
     ...
     * @return
     */
    public static Map<String, Object> sendGetData(String server,String api,Map<String, Object> params,Map<String, String> headers) {
   	 	Map<String, Object> resultMAP=new HashMap<>();
        String result=null;
        InputStream inptStream=null;
        InputStream errorStream=null;
     ...
     * @return
     */
    public static  Map<String, Object> sendFormFile(String server,String api,String formdata,String uploadfile,Map<String, String> headers){
    	 Map<String, Object> resultMAP=new HashMap<>();
    ...
    public static void HttpsDebug(String server,String api,String method,String result,int resposeCode,long resposetime){
        if(HttpsDebug){
    ...
    public static HttpsURLConnection HttpsObj(URL url,String RequestMethod,Map<String, String> headers) throws IOException, NoSuchAlgorithmException, KeyManagementException{
    ...
    public static HttpURLConnection HttpObj(URL url,String RequestMethod,Map<String, String> headers) throws IOException{
