...
public class HelperUtil {
		...
		public static boolean checkEmail(String emailstr){
			if(emailstr.equals(""))return true;
			// 验证邮箱的正则表达式 
	    ...
	    public static int clearFiles(File dir,String namestart,int counts){
	        ...
	        if(dir.exists()&&dir.isDirectory()){ 
	             ...
	             while(iter.hasNext()){   
	                 if(!iter.next().getName().startsWith(namestart))iter.remove();  
	             }
	...
	public static boolean isNumber(String strNum){ 
		if(strNum==null||strNum.endsWith("."))return false;
	...
	public static boolean isInteger(String strNum){ 
	    ...
	    return strNum.matches("(^-?[1-9]\\d?$)|^0{1}$");  
	}
